...
public class Spherehandler : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Optionally, you can add more logic based on proximity if needed
        // For example, you might trigger events or perform actions when the player is close to the sphere.
    }
}